...
function buildDocs() {
    ...
    #antora --stacktrace antora-playbook-local.yml
    DOCSEARCH_ENABLED=true DOCSEARCH_ENGINE=lunr antora generate antora-playbook-local.yml --stacktrace --generator antora-site-generator-lunr --clean --fetch
